...
public class StudentOrderDaoImpl implements StudentOrderDao{
    ...
    private Adult fillAdult(ResultSet rs, String pref) throws SQLException {
        ...
        adult.setDataOfBirth(rs.getDate(pref + "date_of_birth").toLocalDate());
        ...
        PasportOffice po = new PasportOffice(rs.getLong(pref + "passport_office_id"), "","");
    ...
    private void setParamForPerson(PreparedStatement stmt, int start, Person person) throws SQLException {
        ...
        stmt.setDate(start + 3, Date.valueOf(person.getDataOfBirth()));
    }

    private void setParamsForAddress(PreparedStatement stmt, int start, Person person) throws SQLException {
        Address a_address = person.getAddress();
        stmt.setString(start, a_address.getPostCode());
        stmt.setLong(start + 1, a_address.getStreet().getStreetCode());
        stmt.setString(start + 2, a_address.getBuilding());
        stmt.setString(start + 3, a_address.getExtension());
        stmt.setString(start + 4, a_address.getAppartment());
    }
